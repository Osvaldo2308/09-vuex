...
describe('Pruebas en useAuth', ()=>{
    ...
    test('createUser Exitoso',async()=>{
        ...
        const newUser = {name: 'Osvaldo', email:'osvaldo@gmail.com'}
    ...
    test('Login Exitoso',async ()=>{
        ...
        const loginForm = { email:'osvaldo@gmail.com', password:'123456'}
    ...
    test('Computed: authState, username', ()=>{
        ...
        expect(username.value).toBe('Osvaldo')
    })
})